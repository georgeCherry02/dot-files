# Generated by Powerlevel10k configuration wizard on 2021-11-18 at 14:52 GMT.
...
() {
  ...
  prompt_tidy_dir () {
    ...
    IFS='/'
    echo $WD | read -A WD_ARR

    if grep -q "/home/gcherry11" <<< "$WD"; then
      WD_ARR=('~' ${WD_ARR[@]:3});
      WD="${(j:/:)WD_ARR[@]}";
    elif grep -q "^/c/" <<< "$WD"; then
      WD_ARR=('~' ${WD_ARR[@]});
      WD="${(j:/:)WD_ARR[@]}";
    elif grep -q "^/mnt/c" <<< "$WD"; then
      WD_ARR=('~' ${WD_ARR[@]:2});
      WD="${(j:/:)WD_ARR[@]}";
    fi
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    tidy_dir                # tidies up the dir prompt
    vcs                     # git status
  ...
  typeset -g POWERLEVEL9K_TIDY_DIR_FOREGROUND=39
  ...
  typeset -g POWERLEVEL9K_TIDY_DIR_ANCHOR_BOLD=true
